...
MUINT main1_Capture_Width  = 1920;
MUINT main1_Capture_Height = 960;
...
MUINT main2_Capture_Width  = 1920;
MUINT main2_Capture_Height = 960;
MUINT main2_Capture_Offsetx = 0;
MUINT main2_Capture_Offsety = 0;
MUINT PV_720P_W        = 1280;
MUINT PV_720P_H        = 720;
MUINT FE_BLOCK_NUM     = 1;
MUINT FE_IMAGE_WIDTH   = 1536/2;
MUINT FE_IMAGE_HEIGHT  = 864/2;
...
StereoHal()
    ...
    , mAlgoSize()
    , mMainSize(MSize(1920,960))
    //, mFEImgSize(MSize(PV_720P_W, PV_720P_H)*STEREO_FACTOR/100)
    , mFEImgSize(MSize(PV_720P_W, PV_720P_H))
{
}
...
StereoHal::getRrzSize(MUINT32 const idx) const
{
    ...
    //return MSize(1280*1.2, 720*1.2);
    //return MSize(1280, 720);
    //return MSize(1280, 704);
...
StereoHal::STEREOGetRrzInfo(RRZ_DATA_STEREO_T &OutData) const
{
    ...
    //OutData.rrz_crop_main1  = MRect(MPoint(0,0), MSize(1904,1064));
    OutData.rrz_crop_main1  = MRect(MPoint(0,0), MSize(1920,1080));
    //OutData.rrz_crop_main1  = MRect(MPoint((1912-1072)/2,0), MSize(1072,1072));
    //OutData.rrz_crop_main1  = MRect(MPoint(7,0), MSize(1890,1064));
    OutData.rrz_size_main1  = getRrzSize(0);
    //OutData.rrz_crop_main2  = MRect(MPoint(0,240), MSize(2560,1440));
    //OutData.rrz_crop_main2  = MRect(MPoint(0,0), MSize(1904,1064));
    OutData.rrz_crop_main2  = MRect(MPoint(0,0), MSize(1920,1080));
    //OutData.rrz_crop_main2  = MRect(MPoint((1912-1072)/2,0), MSize(1072,1072));
    //OutData.rrz_crop_main2  = MRect(MPoint(7,0), MSize(1890,1064));
