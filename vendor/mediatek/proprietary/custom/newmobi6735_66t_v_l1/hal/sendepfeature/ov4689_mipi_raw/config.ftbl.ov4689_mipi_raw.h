...
//                MtkCameraParameters::EFFECT_F1977 ,
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "1600x1200",    "1920x960",  "1920x1088",    "2048x1536",    "2560x1440",    "2560x1920",    "2880x1728",
            )
        ),
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
            #if PROJECT_k35v1_op01_qhd_512m || PROJECT_k35v1_op02_qhd_512m || PROJECT_k35v1_op09_qhd_svlte_gmo_512m
                ...
                "176x144",      "320x240",      "352x288",      "480x320",      "480x368",
                "640x480",      "720x480",      "800x480",      "800x600",      "864x480",
                "960x540",      "1280x720",     "1440x1080",   "1920x960",   "1920x1080",    "1920x1088",
                "1872x1120",
            #endif
            )
        ),
...
else
{
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "176x144",      "320x240",      "352x288",      "480x320",      "640x480",
                "720x480",      "864x480",      "1280x720",  "1920x960",    "1920x1080", 
                "1280x736",     "1920x1088",
            )
        ),
    )
